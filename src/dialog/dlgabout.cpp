...
DlgAbout::DlgAbout(QWidget *parent) : QDialog(parent), Ui::DlgAboutDlg() {
  ...
  thisReleaseDevelopers << "RJ Skerry-Ryan"
                        << "Owen Williams"
                        << "Sean Pappalardo"
  ...
  recentContributors << "Stefan N&uuml;rnberger"
                     << "Tuukka Pasanen"
                     << "Nino MP"
                     << "Nico Schl&ouml;mer"
                     << "Ferran Pujol Camins"
  ...
  QString sectionTemplate =
      QString("<p align=\"center\"><b>%1</b></p><p align=\"center\">%2</p>");
  QStringList sections;
  sections << sectionTemplate.arg(s_devTeam, thisReleaseDevelopers.join("<br>"))
           << sectionTemplate.arg(s_contributions,
                                  recentContributors.join("<br>"))
           << sectionTemplate.arg(s_pastDevs, pastDevelopers.join("<br>"))
           << sectionTemplate.arg(s_pastContribs, pastContributors.join("<br>"))
           << sectionTemplate.arg(s_specialThanks, specialThanks.join("<br>"));
