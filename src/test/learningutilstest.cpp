...
TEST_F(LearningUtilsTest, NoteOnButton) {
    ...
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0x10, 0x00);
    ...
    EXPECT_EQ(MidiInputMapping(MidiKey(MidiOpCode::NOTE_ON | 0x01, 0x10),
                               MidiOptions(), control),
              mappings.first());
}
...
TEST_F(LearningUtilsTest, NoteOnNoteOffButton) {
    // Status: 0x91, Control: 0x10
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::NOTE_OFF | 0x01, 0x10, 0x00);
    ...
    EXPECT_EQ(MidiInputMapping(MidiKey(MidiOpCode::NOTE_ON | 0x01, 0x10),
                               MidiOptions(), control),
              mappings.at(0));
    EXPECT_EQ(MidiInputMapping(MidiKey(MidiOpCode::NOTE_OFF | 0x01, 0x10),
                               MidiOptions(), control),
              mappings.at(1));
}

TEST_F(LearningUtilsTest, CC7BitKnob) {
    // Standard CC 7-bit knobs show up as a MidiOpCode::CC message, single channel,
    // single control and a variety of values in the range of 0x00 to 0x7F.
    // Status: 0x81 Control: 0x01
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x70);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x60);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x50);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x60);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x50);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x40);
    ...
    ASSERT_EQ(1, mappings.size());
    EXPECT_EQ(MidiInputMapping(MidiKey(MidiOpCode::CC | 0x01, 0x10),
                               MidiOptions(), control),
              mappings.at(0));
}
...
TEST_F(LearningUtilsTest, CC7BitKnob_CenterPointButton_NoteOn) {
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x60);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x50);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x41);
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0xE0, 0x7F);
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0xE0, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x3F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x30);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x20);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x10);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
    ...
    ASSERT_EQ(2, mappings.size());
    EXPECT_TRUE(mappings.contains(MidiInputMapping(MidiKey(MidiOpCode::CC | 0x01, 0x10),
                                                   MidiOptions(), control)));
    EXPECT_TRUE(mappings.contains(MidiInputMapping(MidiKey(MidiOpCode::NOTE_ON | 0x01, 0xE0),
    ...
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0xE0, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x3F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x35);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x30);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x25);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x20);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x15);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x10);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x05);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
...
TEST_F(LearningUtilsTest, CC14BitKnob_MSBFirst) {
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x40);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x01);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x01);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x40);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x01);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x40);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x03);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x00);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x03);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x40);
    addMessage(MidiOpCode::CC | 0x01, 0x11, 0x03);
    ...
    EXPECT_TRUE(mappings.contains(MidiInputMapping(MidiKey(MidiOpCode::CC | 0x01, 0x11),
                                                   msb_option, control)));
}
...
TEST_F(LearningUtilsTest, CC7BitKnob_ConfusableForCC7BitTicker_Zeroes) {
    ...
    // knob.
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x01);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x03);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x01);
    ...
    ASSERT_EQ(1, mappings.size());
    EXPECT_EQ(MidiInputMapping(MidiKey(MidiOpCode::CC | 0x01, 0x10), options, control),
              mappings.at(0));
...
TEST_F(LearningUtilsTest, CC7BitKnob_ConfusableForCC7BitTicker) {
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x75);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x70);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x65);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x60);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x55);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x50);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x45);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x50);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x60);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x75);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7F);
...
TEST_F(LearningUtilsTest, CC7BitKnob_ConfusableForSpread64Ticker_StartAndStopOn41) {
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x70);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x75);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x62);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x52);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x48);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x46);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x41);
...
TEST_F(LearningUtilsTest, CC7BitTicker) {
    // A CC 7-bit ticker (select knob, jog wheel, etc.) shows up as a MidiOpCode::CC
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x02);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x05);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7E);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x7C);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x70);
...
TEST_F(LearningUtilsTest, Spread64Ticker) {
    // A Spread64 ticker (select knob, jog wheel, etc.) shows up as a MidiOpCode::CC
    ...
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x41);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x41);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x42);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x41);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x3F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x3F);
    addMessage(MidiOpCode::CC | 0x01, 0x10, 0x3F);
...
TEST_F(LearningUtilsTest, MultipleControlsUnrecognized_BindsFirst) {
    ...
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0x11, 0x7F);
    addMessage(MidiOpCode::NOTE_ON | 0x01, 0x11, 0x00);
...
TEST_F(LearningUtilsTest, MultipleChannelsUnrecognized_BindsFirst) {
    ...
    // Status 0x91, Control 0x11
    addMessage(MidiOpCode::NOTE_ON | 0x02, 0x10, 0x7F);
    addMessage(MidiOpCode::NOTE_ON | 0x02, 0x10, 0x00);
