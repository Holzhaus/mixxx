#ifndef MIXXX_SERATOMARKERS_H
#define MIXXX_SERATOMARKERS_H
...
public:
    SeratoMarkers2()
        : SeratoMarkers2(QList<std::shared_ptr<SeratoMarkers2Entry>>()) {
    }
    SeratoMarkers2(QList<std::shared_ptr<SeratoMarkers2Entry>> entries)
        : m_entries(entries) {
    }
    ...
    QList<std::shared_ptr<SeratoMarkers2Entry>> getEntries() const {
        return m_entries;
    }
