...
def define_test_targets(default=False):
        ...
        test_env.Append(CPPPATH="lib/gtest-1.8.1/googletest/include")
        test_env.Append(LIBPATH="lib/gtest-1.8.1/googletest")
        test_env.Append(LIBS=['gtest'])

        test_env.Append(CPPPATH="lib/gtest-1.8.1/googlemock/include")
        test_env.Append(LIBPATH="lib/gtest-1.8.1/googlemock")
