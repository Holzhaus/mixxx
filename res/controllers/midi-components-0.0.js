...
(function(global) {
    ...
    var CueButton = class extends Button {
        constructor(options) {
    ...
    var SyncButton = class extends Button {
        constructor(options) {
    ...
    var LoopToggleButton = class extends Button {
        constructor(options) {
    ...
    var HotcueButton = class extends Button {
        constructor(options) {
    ...
    var SamplerButton = class extends Button {
        constructor(options) {
            if (options.number === undefined) {
    ...
    var EffectAssignmentButton = class extends Button {
        constructor(options) {
    ...
    var Pot = class Pot extends Component {
        constructor(options) {
            super(options);
    ...
    **/
    ...
    var Deck = class extends ComponentContainer {
